...
for (let x=0; x<=19; x++) {
imagen = producto[x].image;
cardimgtop[x].insertAdjacentHTML("afterbegin",`<img src="${imagen}" width="300" height="300" >`);
titulo = producto[x].title;
cardtitle[x].insertAdjacentHTML("beforeend", titulo);
